...
N = int(M*(M+1)/2)
v1 = DeterministicVariable(np.random.normal(0., 0.1, (N,)), "v1", learnable=True)
v2 = DeterministicVariable(np.random.normal(0., 0.1, (N,)), "v2", learnable=True)
b1 = DeterministicVariable(np.random.normal(0., 0.1, (M,1)), "b1", learnable=True)
w1 = DeterministicVariable(np.random.normal(0., 0.1, (N,)), "w1", learnable=True)
w2 = DeterministicVariable(np.random.normal(0., 0.1, (N,)), "w2", learnable=True)
b2 = DeterministicVariable(np.random.normal(0., 0.1, (M,1)), "b2", learnable=True)
...
#Plot posterior
plot_posterior(model, variables=["y0", "y1"])
plt.show()
