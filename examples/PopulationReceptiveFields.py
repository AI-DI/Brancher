...
w1 = NormalStandardVariable(0., 1., name="w1")
w2 = NormalStandardVariable(0., 1., name="w2")
b = NormalStandardVariable(0., 1., name="b")
experimental_input = NormalStandardVariable(BF.exp(BF.sin(w1 * x + w2 * y + b)), 0.1, name="input", is_observed=True)

# Probabilistic Model
mu_x = NormalStandardVariable(0., 1., name="mu_x")
mu_y = NormalStandardVariable(0., 1., name="mu_y")
v = LogNormalStandardVariable(0., 0.1, name="v")
nu = LogNormalStandardVariable(-1, 0.01, name="nu")
...
response = NormalStandardVariable(mean_response, nu, name="response")
...
# Variational model
Qmu_x = NormalStandardVariable(0., 1., name="mu_x", learnable=True)
Qmu_y = NormalStandardVariable(0., 1., name="mu_y", learnable=True)
Qv = LogNormalStandardVariable(0., 0.1, name="v", learnable=True)
Qnu = LogNormalStandardVariable(-1, 0.01, name="nu", learnable=True)
