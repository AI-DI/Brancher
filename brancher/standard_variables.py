...
class EmpiricalVariable(StandardVariable):
    ...
    uniformly chosen.
    """
    def __init__(self, dataset, name, learnable=False, has_bias=False, is_observed=False, batch_size=None, indices=None, weights=None, is_policy=False, is_reward=False): #TODO: Ugly logic
        ...
        kwargs = {par_name: par_value
                  for par_name, par_value in input_parameters.items()
                  if par_value is not None}
        super().__init__(name, **kwargs, learnable=learnable, has_bias=has_bias, ranges=ranges, is_observed=is_observed, is_policy=is_policy, is_reward=is_reward)
...
class RandomIndices(EmpiricalVariable):
    ...
    """
    def __init__(self, dataset_size, batch_size, name, has_bias=False, is_observed=False, is_policy=False, is_reward=False):
        self._type = "Random Index"
        super().__init__(dataset=list(range(dataset_size)), batch_size=batch_size, has_bias=has_bias, is_observed=is_observed, name=name, is_policy=is_policy, is_reward=is_reward)
...
class StudentTVariable(StandardVariable):
    ...
    """
    def __init__(self, df, loc, scale, name, learnable=False, has_bias=False, is_observed=False, is_policy=False, is_reward=False):
        self._type = "StudentT"
...
class HalfCauchyVariable(StandardVariable):
    ...
    """
    def __init__(self, scale, name, learnable=False, has_bias=False, is_observed=False, is_policy=False, is_reward=False):
...
class Chi2Variable(StandardVariable):
    ...
    """
    def __init__(self, df, name, learnable=False, has_bias=False, is_observed=False, is_policy=False, is_reward=False):
        self._type = "Chi2"
...
class BernoulliVariable(StandardVariable):
    ...
    brancher.Variables and brancher.PartialLinks. The log-odds of sampling a success.
    """
    def __init__(self, probs=None, logits=None, name="Bernoulli", learnable=False,
                 has_bias=False, is_observed=False, is_policy=False, is_reward=False):
...
class GeometricVariable(StandardVariable):
    ...
    brancher.Variables and brancher.PartialLinks. The log-odds of sampling a success.
    """
    def __init__(self, probs=None, logits=None, name="Geometric", learnable=False, has_bias=False,
...
class CategoricalVariable(StandardVariable):
    ...
    """
    def __init__(self, probs=None, logits=None, name="Categorical", learnable=False, has_bias=False,
                 is_observed=False, is_policy=False, is_reward=False):
